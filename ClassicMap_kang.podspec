Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/willsbor/ClassicMap.git', :tag => '0.0.3' }
  ...
  s.source_files = 'ClassicMap/WMOverlay.{h,m}', 'ClassicMap/WMOverlayView.{h,m}', 'ClassicMap/WMImageCache.{h,m}', 'LoadingTile.png', 'LoadingTile@2x.png'
